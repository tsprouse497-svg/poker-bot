...
- **No PokerNow automation, and no browser or platform observation.** Lifts at phase 20, bounded to Taylor's own home games and nothing else; public real-money tables stay forbidden. The 2026-08-15 ruling that kept both out of v2 on terms-of-service and account-risk grounds is superseded for private home games and stands unchanged for everything else. Nothing before phase 20 opens a browser or drives a table.
...
- **No large hand-history ingestion.** Lifts bounded, for a single player's own exported history with a stated size bound, not corpus-scale mining. That bound is still owed as a number, and the lift is not usable until the number exists.
