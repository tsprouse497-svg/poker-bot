...
ARTIFACT_NOTES = (
    ...
    " excludes 33,720 of them, which is 98.59 percent of the preflop decisions the bot"
    " ever faces. Every absence is a decision, and a reader who cannot see why would read"
    " a missing range as a gap in the conversion."
    "\n\n"
    ...
    " move. Merged and not deleted: at 9 of those spots a hand's whole weight sits on"
    " calling, and deleting would leave a hand with no answer at all. The big blind's"
