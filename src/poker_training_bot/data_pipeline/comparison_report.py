...
def render_refusal_inventory(result: ComparisonResult) -> str:
    lines = [
        ...
        "stripped off. Self-play only ever plays the prices the solved tree holds - six of",
        "them since the blinds were given their own re-raise multiplier, not the three this",
        "line named -",
